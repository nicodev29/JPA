...
import com.example.jpa.Servicios.DireccionServicio;
import com.example.jpa.Servicios.MascotaServicio;
import com.example.jpa.Servicios.PersonaServicio;
...
public class Menu {
    ...
    public void ejecucion() {
        ...
        try {
            ...
            Logger.getLogger(JpaApplication.class.getName()).log(Level.SEVERE, null, ex);
        ...
        Mascota mascota1 = mascotaServicio.crearMascota(nombreMascota1, dniMascota1);
        Mascota mascota2 = mascotaServicio.crearMascota(nombreMascota2, dniMascota2);
        Mascota mascota3 = mascotaServicio.crearMascota(nombreMascota3, dniMascota3);
        ...
        System.out.println(personaServicio.buscarPorPaisYProvincia(pais2, provincia2).toString());
